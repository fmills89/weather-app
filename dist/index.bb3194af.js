...
var getCityDetails = (city)=>{
    ...
    fetch(apiURL).then(function(response) {
        ...
        else alert("Error, this city could not be found.");
    });
};
...
var displayCityDetails = (data, city)=>{
    ...
    tempEl.textContent = "Temperature: " + currentTemp + "\xb0F";
...
var displayForcasted = (data)=>{
    ...
    for(var i = 0; i < 7; i++){
        ...
        cardEl.setAttribute("class", "bg-slate-700 bg-opacity-75 rounded-lg p-6 drop-shadow-xl border border-blue-300 h-full");
        ...
        cardTempEl.setAttribute("class", "border rounded-md bg-white drop-shadow-2xl p-2 m-2");
        cardTempEl.textContent = `Temperature:  ${cityForecast} °F ${type}`;
        var cardWindEl = document.createElement("p");
        cardWindEl.setAttribute("class", "border rounded-md bg-white drop-shadow-2xl p-2 m-2");
        cardWindEl.textContent = `Wind: ${windForecast}`;
        var cardHumidEl = document.createElement("p");
        cardHumidEl.setAttribute("class", "border rounded-md bg-white drop-shadow-2xl p-2 m-2");
...
//# sourceMappingURL=index.bb3194af.js.map
